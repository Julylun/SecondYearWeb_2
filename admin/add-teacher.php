                  ...
                  <form name="addlawyer" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="fullname" name="fullname"
                        placeholder="Enter Teacher Full Name" required>
                    </div>
                    <!--   Email---->
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="tsubject" name="tsubject"
                          placeholder="Enter Subject/Designation" required>
                      </div>
                      ...
                      <!--Profile Pic---->
                      <div class="form-group">
                        <label for="exampleInputFile">Profile Pic <span style="font-size:12px;color:red;">(Only jpg /
                            jpeg/ png /gif format allowed)</span></label>
