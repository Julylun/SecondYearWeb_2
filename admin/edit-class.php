                  ...
                  while ($result = mysqli_fetch_array($query)) {
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="teacher" name="teacher" required>
                        <option value="<?php echo $result['tid']; ?>">
                          <?php echo $result['teachername']; ?>
                        </option>
                    ...
                    <!--   Class---->
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="classname" name="classname"
                            placeholder="Class name e.g: Drawing, Dnace, Fun" value="<?php echo $result['className']; ?>"
                            required>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" id="classtiming" name="classtiming" required>
                            <option value="<?php echo $result['classTiming']; ?>"><?php echo $result['classTiming']; ?>
                            </option>
