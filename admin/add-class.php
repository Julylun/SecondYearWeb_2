...
if (strlen($_SESSION['aid']) == 0) {
  ...
  <head>
    ...
    <title>Sparkle Kids | Add Class</title>
                    ...
                    <!--   Class---->
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="classname" name="classname"
                          placeholder="Class name e.g: Drawing, Dnace, Fun" required>
                      </div>
                      <!--Age Group---->
                      <div class="form-group">
                      ...
                      <!--Class Pic---->
                      <div class="form-group">
                        <label for="exampleInputFile">Class Pic <span style="font-size:12px;color:red;">(Only jpg / jpeg/
                            png /gif format allowed)</span></label>
