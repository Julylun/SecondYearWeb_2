...
<head>
    ...
    <title>Sparkle Kids | Dashboard</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-6">
                        ...
                        <div class="small-box bg-success">
                            <div class="inner">
                                <?php
                                $query1 = mysqli_query($con, "SELECT id FROM tblteachers");
                    ...
                    <div class="col-lg-4 col-6">
                        ...
                        <div class="small-box bg-warning">
                            <div class="inner">
                                <?php
                                $query3 = mysqli_query($con, "SELECT id FROM tblclasses");
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            <div class="inner">
                                <?php
                                $query11 = mysqli_query($con, "SELECT id FROM tblenrollment");
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning">
                            <div class="inner">
                                <?php
                                $query12 = mysqli_query($con, "SELECT id FROM tblenrollment WHERE (enrollStatus='' OR enrollStatus IS NULL)");
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            <div class="inner">
                                <?php
                                $query13 = mysqli_query($con, "SELECT id FROM tblenrollment WHERE enrollStatus='Accepted'");
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-danger">
                            <div class="inner">
                                <?php
                                $query14 = mysqli_query($con, "SELECT id FROM tblenrollment WHERE enrollStatus='Rejected'");
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-primary">
                            <div class="inner">
                                <?php
                                $query111 = mysqli_query($con, "SELECT id FROM tblvisitor");
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning">
                            <div class="inner">
                                <?php
                                $query121 = mysqli_query($con, "SELECT id FROM tblvisitor WHERE (status='' OR status IS NULL)");
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            <div class="inner">
                                <?php
                                $query131 = mysqli_query($con, "SELECT id FROM tblvisitor WHERE status='Visited'");
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-danger">
                            <div class="inner">
                                <?php
                                $query141 = mysqli_query($con, "SELECT id FROM tblvisitor WHERE status='Not-Visited'");
